...
def run_benchmark(ayarlar, endpoint, access_key, secret_key, bucket_name, test_prefix,
    ...
    """Run the benchmark: generate files, upload under prefix, download under prefix,
    collect metrics and return dataframes and summary.
    Returns: df, ozet, upload_df, download_df
    """
